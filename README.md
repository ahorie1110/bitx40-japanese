...
- 送信中は周波数のチューニングを無効にする（送信時のフラッタや“FM-ing”を防ぐため。これには、ピンA0（黒線）に“PTT SENSE”線が接続されている必要があります。 （配線方法は、https://github.com/amunters/bitx40/blob/master/PTT%20SENSE%20wiring.png　を参照）。
